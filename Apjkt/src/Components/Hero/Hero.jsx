...
function Hero() {
  const images1 = [
    ...
    "https://ik.imagekit.io/zhf0gkzac/stock-photo--d-printer-making-object-1369600760-transformed.jpeg?updatedAt=1718428764446",
      "https://ik.imagekit.io/zhf0gkzac/nylon-gears-500x500.webp?updatedAt=1718434496031",
    "https://ik.imagekit.io/zhf0gkzac/cnc.webp?updatedAt=1718434496265",
    
  ];

  const images2 = [
    "https://ik.imagekit.io/zhf0gkzac/DeWatermark.ai_1717408547209.png?updatedAt=1718434496704",
    "https://ik.imagekit.io/zhf0gkzac/plastic-project.jpg?updatedAt=1718434496085",
    "https://ik.imagekit.io/zhf0gkzac/71qhjZ162dL._AC_UF1000,1000_QL80_.jpg?updatedAt=1718434496038",
    ...
    <div className="w-screen h-auto lg:h-auto 2xl:container mx-auto mb-[10px]">
      <div className="w-[90%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 lg:p-[100px]">
        ...
        <div className="grid grid-cols-2 gap-4 p-10">
          <div className="relative h-80 lg:h-[600px] overflow-hidden opacity-top">
          ...
          <div className="relative w-full h-80 lg:h-full overflow-hidden opacity-top">
